...
class Employee(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('employee_detail', kwargs={"id": self.pk})

    def get_edit_url(self):
        return reverse('employee_edit', kwargs={"id": self.pk})

    def get_delete_url(self):
        return reverse('employee_delete', kwargs={"id": self.pk})
...
class Timesheet(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('timesheet_detail', kwargs={"id": self.pk})

    def get_edit_url(self):
        return reverse('timesheet_edit', kwargs={"id": self.pk})

    def get_delete_url(self):
        return reverse('timesheet_delete', kwargs={"id": self.pk})
...
class LeaveRequest(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('expensevoucher_detail', kwargs={"id": self.pk})

    def get_edit_url(self):
        return reverse('expensevoucher_edit', kwargs={"id": self.pk})

    def get_delete_url(self):
        return reverse('expensevoucher_delete', kwargs={"id": self.pk})
