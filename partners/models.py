...
class Contact(Commentable):
    ...
    def get_edit_url(self):
        return reverse('contact_edit', kwargs={'id': self.pk})

    def get_delete_url(self):
        return reverse('contact_delete', kwargs={'id': self.pk})
...
class Partner(Commentable):
    ...
    def get_absolute_url(self):
        return reverse('partner_detail', kwargs={'id': self.pk})

    def get_edit_url(self):
        return reverse('partner_edit', kwargs={'id': self.pk})

    def get_delete_url(self):
        return reverse('partner_delete', kwargs={'id': self.pk})
...
class Job(models.Model):
    ...
    def __str__(self):
        return _(f"{self.contact} as {self.get_role_display()}")
    ...
    def get_edit_url(self):
        return reverse('contact_edit_job', kwargs={
            "contact_id": self.contact.pk, 
            "id": self.pk
        })
    
    def get_delete_url(self):
        return reverse('contact_delete_job', kwargs={
            "contact_id": self.contact.pk, 
            "id": self.pk
        })
...
class Letter(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('letter_detail', kwargs={'id': self.pk})

    def get_edit_url(self):
        return reverse('letter_edit', kwargs={'id': self.pk})

    def get_delete_url(self):
        return reverse('letter_delete', kwargs={'id': self.pk})
