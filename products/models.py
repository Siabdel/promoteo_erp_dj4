...
class Product(Commentable):
    ...
    def get_edit_url(self):
        return reverse('product_edit', kwargs={'id': self.pk})

    def get_delete_url(self):
        return reverse('product_delete', kwargs={'id': self.pk})
...
class Supply(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('product_supply_detail', kwargs={
            "product_id": self.product.pk, 
            "id": self.pk
        })
    
    def get_edit_url(self):
        return reverse('product_edit_supply', kwargs={
            "product_id": self.product.pk, 
            "id": self.pk
        })
    
    def get_delete_url(self):
        return reverse('product_delete_supply', kwargs={
            "product_id": self.product.pk, 
            "id": self.pk
        })
