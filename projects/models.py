...
class Project(Commentable):
    ...
    def get_absolute_url(self):
        return reverse('project_detail', kwargs={"code": self.code})

    def get_edit_url(self):
        return reverse('project_edit', kwargs={"code": self.code})

    def get_delete_url(self):
        return reverse('project_delete', kwargs={"code": self.code})
...
class Milestone(Commentable):
    ...
    def get_absolute_url(self):
        return reverse('milestone_detail', kwargs={
            "project": self.project.code, 
            "code": self.code
        })

    def get_edit_url(self):
        return reverse('milestone_edit', kwargs={
            "project": self.project.code, 
            "code": self.code
        })

    def get_delete_url(self):
        return reverse('milestone_delete', kwargs={
            "project": self.project.code, 
            "code": self.code
        })
